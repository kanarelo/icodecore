 ...
 */
public abstract class BaseHibernateDao<E extends BaseModel> extends HibernateDaoSupport implements BaseDao<E>{
	/** Logging object */
	 ...
	 * @return a list of Es matching the supplied query
	 */
	public List<E> getList(String hqlQuery, int startIndex, int limit, Object... values) {
